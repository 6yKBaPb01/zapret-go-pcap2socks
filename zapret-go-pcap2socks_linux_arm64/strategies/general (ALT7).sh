...
# Source: general (ALT7).bat (auto-converted)
...
--new
--ipset=$LISTS_DIR/ipset-all.txt --ipset-exclude=$LISTS_DIR/ipset-exclude.txt --ipset-exclude=$LISTS_DIR/ipset-exclude-user.txt --dpi-desync=syndata --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n3
--new
