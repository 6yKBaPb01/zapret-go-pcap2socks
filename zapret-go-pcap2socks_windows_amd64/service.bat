...
echo.
echo   ZAPRET-GO-PCAP2SOCKS v!LOCAL_VERSION!
echo   ----------------------------------------
echo.
echo   :: SERVICE
...
echo.
call :test_service go-pcap2socks
call :test_service TgWsProxy
:: Extra hint for TG WS Proxy
sc query "TgWsProxy" | findstr /i "RUNNING" >nul 2>&1
if !errorlevel!==0 (
    echo [!] TgWsProxy is running. Make sure the proxy is enabled in the application itself.
)
:: ======================================================
