...
# Source: general (ALT10).bat (auto-converted)
...
--new
--ipset=$LISTS_DIR/ipset-all.txt --ipset-exclude=$LISTS_DIR/ipset-exclude.txt --ipset-exclude=$LISTS_DIR/ipset-exclude-user.txt --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n2 --dpi-desync-fooling=ts --dpi-desync-fake-tls=$BIN_DIR/stun.bin --dpi-desync-fake-tls=$BIN_DIR/tls_clienthello_4pda_to.bin --dpi-desync-fake-http=$BIN_DIR/tls_clienthello_max_ru.bin
--new
