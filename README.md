...
> 1) публикация в телеграм каналах(или в других площадках). Разрешаются только новости или предложения.
> 2) другой автор в GitHub (но если это форк,**НУЖНО ПРОВЕРИТЬ НА ВИРУСЫ!!!**). Если были какие то попытки подменить мой ник или не форк - точно скам
...
- Пинг ВПН взлетает до небес. (это проблема уже касается zapret)
## 💾 Установка через Git
